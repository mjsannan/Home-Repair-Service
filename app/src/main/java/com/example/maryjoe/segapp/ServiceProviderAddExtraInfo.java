...
public class ServiceProviderAddExtraInfo extends AppCompatActivity {
    ...
    public ServiceProviderAddExtraInfo(String address, String phoneNum, String companyName, String description, String licensed){
    ...
    public ServiceProviderAddExtraInfo(){}
    ...
    public void gotoServiceProviderHome(View v){
        ...
        EditText editTextDescription = (EditText) findViewById(R.id.comment);
